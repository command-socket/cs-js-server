...
import { CommandRegistry, CommandSetStructure, FullCommandSet } from "@command-socket/core";
...
export declare class CommandSocketServer<LCS extends CommandSetStructure = any, RCS extends CommandSetStructure = any> {
    ...
    constructor(port: number, commandRegistry?: CommandRegistry<FullCommandSet<LCS>>);
